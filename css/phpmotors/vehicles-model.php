<?php
    function classificationList(){
       ...
       //This adds a vehicle
    function regVehicle($invMake, $invModel, $invDescription, $invPrice, $invStock, $invColor, $invImage, $invThumbnail, $classificationName){
        // Create a connection object using the phpmotors connection function
        $db = phpmotorsConnect();
        // The SQL statement
        $sql = 'INSERT INTO inventory (invMake, invModel, invDescription, invPrice, invStock, invColor, invImage, invThumbnail, classificationId)
            VALUES (:invMake, :invModel, :invDescription, :invPrice, :invStock, :invColor, :invImage, :invThumbnail, :classificationId)';
        ...
        $stmt->bindValue(':classificationId', $classificationName, PDO::PARAM_STR);
        // Insert the data
        $stmt->execute();
...
// Get information for/about all vehicles in inventory
